      ...
      <React.Fragment>
        <tr className={`${isGroupingTopic ? 'bg-gray-50 dark:bg-gray-800' : ''}`}>
          ...
          <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
            <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${isTopicStudied ? 'bg-gold-100 dark:bg-gold-800 text-gold-800 dark:text-gold-200' : 'bg-red-100 dark:bg-red-800 text-red-800 dark:text-red-200'}`}>
          ...
          <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
            <button 
              ...
              className={`p-2 rounded-full ${isGroupingTopic ? 'text-gray-400 dark:text-gray-600 cursor-not-allowed' : 'text-gold-600 dark:text-gold-400 hover:text-gold-800 dark:hover:text-gold-300'}`}
      ...
      <div className="w-full">
          ...
          <header className="flex justify-between items-center pt-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className="bg-white dark:bg-gray-700 border border-gold-500 dark:border-gold-400 rounded-full py-2 px-4 text-gold-700 dark:text-gold-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors shadow-md text-base font-medium appearance-none pr-8"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md flex flex-col items-center justify-center">
            ...
            <p className="text-2xl font-bold text-gold-600 dark:text-gold-400">{formatTime(totalStudyTime)}</p>
          </div>
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md flex flex-col items-center justify-center">
            ...
            <p className="text-2xl font-bold text-gold-600 dark:text-gold-400">{performancePercentage}%</p>
          </div>
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md flex flex-col items-center justify-center">
            ...
            <p className="text-2xl font-bold text-gold-600 dark:text-gold-400">{progressPercentage}%</p>
          </div>
          <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md flex flex-col items-center justify-center">
            ...
            <p className="text-2xl font-bold text-gold-600 dark:text-gold-400">{totalPagesRead}</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-md mb-8 min-h-[256px]">
          ...
          {filteredStudyRecords.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <button
                onClick={openRegisterModalForNew}
                className="bg-gold-500 hover:bg-gold-600 text-white font-bold py-2 px-4 rounded-lg flex items-center gap-2"
              >
                <FaPlusCircle />
                ...
                <tbody>
                  {filteredStudyRecords.map((record, index) => (
                    <tr key={record.id || index} className="bg-white dark:bg-gray-700">
                      ...
                      <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">
                        <button onClick={() => handleEditRecord(record)} className="text-gold-600 dark:text-gold-400 hover:text-gold-800 dark:hover:text-gold-300 mr-2">Editar</button>
        ...
        <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-md mb-8 min-h-[400px]">
          ...
          <div className="flex justify-center mb-4">
            <button
              ...
              className={`px-4 py-2 rounded-l-lg ${activeTab === 'daily' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200'}`}
            >
              Diário
            </button>
            <button
              onClick={() => setActiveTab('weekly')}
              className={`px-4 py-2 ${activeTab === 'weekly' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200'}`}
            >
              Semanal
            </button>
            <button
              onClick={() => setActiveTab('monthly')}
              className={`px-4 py-2 rounded-r-lg ${activeTab === 'monthly' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200'}`}
            >
              Mensal
            </button>
          </div>
