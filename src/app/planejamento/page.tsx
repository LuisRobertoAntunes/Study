          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
            ...
            <div className="md:col-span-3 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-6 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-300 to-blue-800 h-6 rounded-full" style={{ width: `${weeklyProgressPercent}%`, transition: 'width 0.5s ease-in-out' }}></div>
              </div>
            </div>
              ...
              {isEditMode && activeTab === 'pending' && (
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 flex items-center gap-4">
                  <select
                    ...
                    className="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md p-2 focus:ring-gold-500 focus:border-gold-500 flex-grow"
                  >
                  ...
                  <input
                    ...
                    className="bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md p-2 w-24 focus:ring-gold-500 focus:border-gold-500"
                    min="15"
                    step="15"
                  />
