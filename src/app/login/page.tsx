      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="bg-gold-500 hover:bg-gold-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            >
              Entrar
            </button>
            <Link href="/register" className="inline-block align-baseline font-bold text-sm text-gold-500 hover:text-gold-800">
