        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
            ...
            <div className="relative flex-grow bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full">
              ...
              {/* Informações */}
              <div>
                <h1 className="text-3xl font-bold text-gold-500 mb-4">{planData.name}</h1>
                {planData.edital && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" key="subjects-grid">
            <div className="lg:col-span-3 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex justify-around items-center text-center">
              <div className="flex flex-col items-center">
                <span className="text-2xl font-bold text-gold-500">{formatTime(planStats.totalStudyTime)}</span>
                <span className="text-sm text-gray-600 dark:text-gray-300">Horas Estudadas</span>
              </div>
              <div className="flex flex-col items-center">
                <span className="text-2xl font-bold text-gold-500">{planStats.totalQuestions}</span>
                <span className="text-sm text-gray-600 dark:text-gray-300">Questões Resolvidas</span>
              </div>
              <div className="flex flex-col items-center">
                <span className="text-2xl font-bold text-gold-500">{planStats.overallPerformance}%</span>
              ...
              return (
                ...
                >
                  <div className="flex items-center mb-2">
                    <span className="bg-gold-500 text-white text-xs font-semibold px-2.5 py-0.5 rounded-md mr-2">
                      {planData.name}
                    </span>
