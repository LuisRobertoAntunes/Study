...
export default function Estatisticas() {
  ...
  const lineOptions = {
    ...
    plugins: {
      ...
      tooltip: {
        titleColor: '#fafafaff', // Cor do título do tooltip
        bodyColor: '#fafafaff', // Cor do corpo do tooltip
      },
      zoom: {
        pan: {
          enabled: true,
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="col-span-1 flex flex-col gap-4">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[200px] flex flex-col items-start">
              ...
              <p className="text-3xl font-bold text-gold-500">{formatTime(stats.totalStudyTime)}</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[200px] flex flex-col items-start">
                ...
                <p className="text-3xl font-bold text-gold-500">{stats.totalPagesRead}</p>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[200px] flex flex-col items-start">
                ...
                <p className="text-3xl font-bold text-gold-500">{formatTime(stats.totalVideoTime)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 flex flex-col gap-4">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[200px] flex flex-col items-start">
              ...
              <p className="text-3xl font-bold text-gold-500">{stats.studyConsistencyPercentage.toFixed(1)}%</p>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[200px] flex flex-col items-start">
              ...
              <p className="text-3xl font-bold text-gold-500">{stats.overallEditalProgress.toFixed(1)}%</p>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md min-h-[600px] flex flex-col">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex space-x-2">
                <button onClick={() => setSubjectSortOrder('desc')} className={`p-1 rounded-md ${subjectSortOrder === 'desc' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-700'}`} title="Ordenar descendente"><BsArrowDown /></button>
                <button onClick={() => setSubjectSortOrder('asc')} className={`p-1 rounded-md ${subjectSortOrder === 'asc' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-700'}`} title="Ordenar ascendente"><BsArrowUp /></button>
                <button onClick={() => setSubjectSortOrder('alpha')} className={`p-1 rounded-md ${subjectSortOrder === 'alpha' ? 'bg-gold-500 text-white' : 'bg-gray-200 dark:bg-gray-700'}`} title="Ordenar alfabeticamente">A-Z</button>
              </div>
            </div>
              ...
              {chartJsLoaded && Object.keys(stats.topicPerformance).length === 0 ? (
                ...
                chartJsLoaded && (
                  <table className="divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gold-50 dark:bg-gold-900">
                      <tr>
                        <th scope="col" className="w-3/5 px-4 py-3 text-left text-xs font-medium text-gold-700 dark:text-gold-300 uppercase tracking-wider break-words border-r border-gold-200 dark:border-gold-700">
                          <button onClick={() => setAllTopicsExpanded(prev => !prev)} className="mr-2 p-1 rounded-full hover:bg-gold-100 dark:hover:bg-gold-800">
                            {allTopicsExpanded ? <BsChevronDown /> : <BsChevronRight />}
                          </button>
                          Disciplina/Tópico
                        </th>
                        <th scope="col" className="w-1/10 px-4 py-3 text-center text-xs font-medium text-gold-700 dark:text-gold-300 uppercase tracking-wider break-words border-r border-gold-200 dark:border-gold-700">
                          Acertos
                        </th>
                        <th scope="col" className="w-1/10 px-4 py-3 text-center text-xs font-medium text-gold-700 dark:text-gold-300 uppercase tracking-wider break-words border-r border-gold-200 dark:border-gold-700">
                          Erros
                        ...
                        <th scope="col" className="w-1/10 px-4 py-3 text-center text-xs font-medium text-gold-700 dark:text-gold-300 uppercase tracking-wider break-words">
                          Desempenho
                        </th>
                      </tr>
                    </thead>
