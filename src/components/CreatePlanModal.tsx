      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 w-full max-w-2xl transform transition-transform duration-300 ease-out scale-100">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex flex-col items-center justify-center w-1/3">
            ...
            <button 
              onClick={handleImageClick}
              className="text-sm text-gold-600 hover:text-gold-800 font-semibold dark:text-gold-400 dark:hover:text-gold-300"
            >
              Alterar Imagem
            </button>
          </div>
          ...
          <div className="flex-1">
            <form>
              <div className="mb-4">
                <label htmlFor="planName" className="block text-sm font-bold text-gold-800 dark:text-gold-300 mb-2">
                  NOME
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="cargo" className="block text-sm font-bold text-gold-800 dark:text-gold-300 mb-2">
                  CARGO (Opcional)
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="edital" className="block text-sm font-bold text-gold-800 dark:text-gold-300 mb-2">
                  EDITAL (Opcional)
                </label>
                <input
                  type="text"
              ...
              <div className="mb-4">
                <label htmlFor="banca" className="block text-sm font-bold text-gold-800 dark:text-gold-300 mb-2">
                  BANCA (Opcional)
                </label>
                <input
                  type="text"
              ...
              <div className="mb-6">
                <label htmlFor="observations" className="block text-sm font-bold text-gold-800 dark:text-gold-300 mb-2">
        ...
        <div className="flex justify-end gap-4 mt-8">
          ...
          <button
            onClick={handleSave}
            className="px-6 py-2 bg-gold-500 text-white font-semibold rounded-lg hover:bg-gold-600 transition-colors dark:bg-gold-600 dark:hover:bg-gold-700"
          >
            Avançar
          </button>
        </div>
