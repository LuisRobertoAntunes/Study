  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl h-[95vh] flex flex-col animate-scale-in">
        {/* Header */}
        <div className="flex justify-between items-center p-4 border-b border-gold-200 dark:border-gold-700">
          <h2 className="text-2xl font-bold text-gold-700 dark:text-gold-300">Filtros Avançados</h2>
            ...
            <section className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <DatePicker
                  ...
                  className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gold-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
        ...
        {/* Footer */}
        <div className="flex justify-end p-4 border-t border-gold-200 bg-gold-50/50 space-x-4 dark:border-gold-700 dark:bg-gold-900/50">
          ...
          <button onClick={handleApply} className="bg-gold-600 hover:bg-gold-700 text-white font-bold py-2 px-6 rounded-lg dark:bg-gold-700 dark:hover:bg-gold-800 transition-colors duration-200">
            Aplicar
          </button>
        </div>
      </div>
